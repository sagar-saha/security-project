...
$password = $_POST["password"];
 $gen=$_POST['gender'];
$fastname = mysqli_real_escape_string($db, $fname);
$lastname = mysqli_real_escape_string($db, $lname);
...
{
$sq="INSERT INTO `user`(`id`, `fname`, `lname`, `email`, `pass`, `gender`) VALUES ('','$fastname','$lastname','$email','$password','$gen')";
mysqli_query($db,$sq);
